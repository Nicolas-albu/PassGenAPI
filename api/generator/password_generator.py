...
class PasswordGenerator:
    ...
    def generate_password(self) -> Union[list[str], str]:
        ...
        __password_generated: str = generation_cases.get(self.__types_of_characters, 
                                                         self.generate_full_character_password)
        __list_of_passwords: list[str] = [__password_generated() 
                                          for number in range(self.__number_of_passwords) 
                                          if self.__number_of_passwords >= 1]
        return (__list_of_passwords[0] 
